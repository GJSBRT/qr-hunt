...
export default function QRCodes({game, team, teamQRCodes}: Props) {
    return (
        <DashboardLayout 
            ...
            breadcrumbs={[
                ...
                { label: 'Teams', href: route('dashboard.games.teams.index', {
                    id: game.id,
                    teamId: team.id,
                }) },
                { label: 'QR Codes', href: route('dashboard.games.teams.qr-codes.index', {
                    id: game.id,
                    teamId: team.id,
                }) },
            ]}
