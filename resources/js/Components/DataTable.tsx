...
export default function DataTable<T extends object>({ headers, data, searchable, onRowClick, ...props }: Props<T>) {
    ...
    return (
        ...
        >
            ...
            <Table hover striped>
                ...
                <TableBody classes={{ tr: (onRowClick) && 'cursor-pointer' }} onRowClick={(row) => {
